 ...
 *
 * @since 6.5
 * @version 2014-1-21 下午03:40:51
 * @author fanly3
 */
public class SaveBeforeEventRule implements ICompareRule<StoreReqAppVO> {
  ...
  private void insertBeforeEvent(StoreReqAppVO[] vos) {
    try {
  ...
  private void updateBeforeEvent(StoreReqAppVO[] vos, StoreReqAppVO[] originVOs) {
    try {
      String sourceid = PUMDValue.StoreReqApp.value();
