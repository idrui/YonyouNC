...
/**
 * 物资需求申请提供给出库申请单的单据参照查询服务
 * 
 * @since 6.0
 * @version 2010-12-16 下午06:27:50
 * @author wuxla
 */

public class BillReferQueryFor4455 extends DefaultBillReferQuery {
  /**
   * @param c
   * @param info
   */
  public BillReferQueryFor4455(Container c, TemplateInfo info) {
    super(c, info);
  }
