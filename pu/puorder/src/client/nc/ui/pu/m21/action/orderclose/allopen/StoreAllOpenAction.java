 ...
 * @time 2010-4-9 上午08:47:15
 */
public class StoreAllOpenAction extends AfterOrderCloseAction {
  ...
  private void doBeforeAction() {
    if (ArrayUtils.isEmpty(this.model.getSelectedOperaDatas())) {
      ExceptionUtils.wrappBusinessException(nc.vo.ml.NCLangRes4VoTransl
          .getNCLangRes().getStrByID("4004030_0", "04004030-0011")/*
                                                                   * @res
                                                                   * "请先选择要整单入库打开行"
                                                                   */);
    }
