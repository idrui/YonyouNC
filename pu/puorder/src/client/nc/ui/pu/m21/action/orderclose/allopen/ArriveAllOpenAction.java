 ...
 * @time 2010-4-9 上午08:45:38
 */
public class ArriveAllOpenAction extends AfterOrderCloseAction {
  ...
  private void doBeforeAction() {
    if (ArrayUtils.isEmpty(this.model.getSelectedOperaDatas())) {
      ExceptionUtils.wrappBusinessException(nc.vo.ml.NCLangRes4VoTransl
          .getNCLangRes().getStrByID("4004030_0", "04004030-0007")/*
                                                                   * @res
                                                                   * "请先选择要整单到货打开行"
                                                                   */);
    }
