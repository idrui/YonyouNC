 ...
 * @time 2010-8-10 上午09:08:11
 */
public class OrderCustomService extends AbstractOrderOnwayService {
  ...
  // if (sqlWhere.indexOf("biscustom = 'N'") > 0) {
  // isDone = false;
  // }
  // else if (sqlWhere.indexOf("biscustom = 'Y'") > 0) {
  // isDone = true;
  // }
  // return isDone;
  // }
  ...
  public int getStatus() {
    return OnwayStatus.STATUS_COMEIN.toInt();
  }
}
