 ...
 * @time 2010-8-10 上午09:08:11
 */
public class OrderOutcustomService extends AbstractOrderOnwayService {
  ...
  // if (sqlWhere.indexOf(OnwayStatusQryEnum.bisoutcustom.name() + " = 'N'") >
  // 0) {
  // isDone = false;
  // }
  // else if (sqlWhere
  // .indexOf(OnwayStatusQryEnum.bisoutcustom.name() + " = 'Y'") > 0) {
  // isDone = true;
  // }
  // return isDone;
  // }
  ...
  public int getStatus() {
    return OnwayStatus.STATUS_GETOUT.toInt();
  }
}
