 ...
 * @time 2010-4-9 上午08:35:06
 */
public class PayAllCloseAction extends AfterOrderCloseAction {
  ...
  private void doBeforeAction() {
    if (ArrayUtils.isEmpty(this.model.getSelectedOperaDatas())) {
      ExceptionUtils.wrappBusinessException(nc.vo.ml.NCLangRes4VoTransl
          .getNCLangRes().getStrByID("4004030_0", "04004030-0004")/*
                                                                   * @res
                                                                   * "请先选择要整单付款关闭行"
                                                                   */);
    }
