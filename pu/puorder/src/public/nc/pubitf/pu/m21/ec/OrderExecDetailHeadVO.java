...
/**
 * @since 6.0
 * @version 2011-5-16 上午11:35:49
 * @author wuxla
 */

public class OrderExecDetailHeadVO extends AbstractDataView {

  private static final long serialVersionUID = 6635009511824264577L;

  public static class OrderExecDetailHeadVOMeta extends DataViewMeta {
    public OrderExecDetailHeadVOMeta() {
      init();
    }

    private void init() {
      // 订单主键、采购订单号、采购组织id、采购部门id、采购员id
      // 订单日期、供应商发货地址id、开票方id、付款协议id、备注,运输方式
  ...
  public IDataViewMeta getMetaData() {
    return DataViewMetaFactory.getInstance().getDataViewMeta(
        OrderExecDetailHeadVOMeta.class);
  }
