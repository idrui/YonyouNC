package nc.test.pubitf.pu.m20.mm.m55B4;
...
public class PushSave20For55B4TestCase extends AbstractTestCase {

  public void test() throws BusinessException {

    IPushSave20For55B4 pushSave20For55B4 =
        NCLocator.getInstance().lookup(IPushSave20For55B4.class);
    ...
    // 推式保存
    pushSave20For55B4.pushSaveBills(praybillVOs);
  }
