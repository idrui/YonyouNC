 ...
 * 
 * @since 6.3
 * @version 2012-11-1 下午08:59:31
 * @author fanly3
 */
public class PrayOrderDTSupplyMapVO implements Serializable {

  private static final long serialVersionUID = 6499561463150886678L;
  ...
  public String getBrowclose() {
    return this.browclose;
  }
  ...
  public void setBrowclose(String browclose) {
    this.browclose = browclose;
  }
