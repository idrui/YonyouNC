...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class NewoabaseaHeadVOTest extends BaseTestCase {
  NewoabaseaHeadVO newoabaseaHeadVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    newoabaseaHeadVO=NCLocator.getInstance().lookup(NewoabaseaHeadVO.class);
  }
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=newoabaseaHeadVO.getMetaData();
