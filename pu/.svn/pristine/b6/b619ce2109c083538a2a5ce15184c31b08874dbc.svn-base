...
public class AggNewoabaseaHeadVOTest extends BaseTestCase {
  AggNewoabaseaHeadVO aggNewoabaseaHeadVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggNewoabaseaHeadVO=NCLocator.getInstance().lookup(AggNewoabaseaHeadVO.class);
  }
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    retObj=aggNewoabaseaHeadVO.getMetaData();
  ...
  public void getParentVO(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    NewoabaseaHeadVO retObj=new NewoabaseaHeadVO();
    retObj=aggNewoabaseaHeadVO.getParentVO();
