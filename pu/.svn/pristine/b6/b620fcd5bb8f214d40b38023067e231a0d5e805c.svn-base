...
import nc.ui.pu.m21.report.action.OrderExecQryAction;
 ...
 * @author zhaoyha
 */
public class OrderExecQryDlgInit extends PuReportDlgInit implements
  ...
  public void initQueryConditionDLG(QueryConditionDLGDelegator condDLGDelegator) {
    ...
    new QTransTypeFilter(condDLGDelegator,
        OrderExecQryDlgInit.PO_ORDER_CTRANTYPEID, POBillType.Order.getCode())
        .filter();
    // 采购部门，参照采购组织下的部门档案输入
    QDeptFilter deptFilter =
        QDeptFilter.createQDeptFilterOfPU(condDLGDelegator,
            OrderExecQryDlgInit.PK_DEPT);
    deptFilter.setPk_orgCode(OrderExecQryAction.mainOrg);
    deptFilter.setbUsedflag(UFBoolean.TRUE);
    deptFilter.addEditorListener();
    // 采购员，参照采购组织下的人员档案输入
    QPsndocFilter psnFilter =
        QPsndocFilter.createQPsndocFilterOfPU(condDLGDelegator,
            OrderExecQryDlgInit.CEMPLOYEEID);
    psnFilter.setPk_orgCode(OrderExecQryAction.mainOrg);
    ...
    supFilter.setPk_orgCode(OrderExecQryAction.mainOrg);
    ...
    marbasFilter.setPk_orgCode(OrderExecQryAction.mainOrg);
    marbasFilter.addEditorListener();
    // 物料编码(OID)
    new QMarterialoidFilter(condDLGDelegator, OrderExecQryAction.mainOrg,
    ...
    marpufilter.setPk_orgCode(OrderExecQryAction.mainOrg);
    ...
    // 项目
    new QProjectFilter(condDLGDelegator, OrderExecQryAction.mainOrg,
    ...
    customerFilter.setPk_orgCode(OrderExecQryAction.mainOrg);
    customerFilter.addEditorListener();
    
    // 按物料过滤特征码
    new QFfileFilter(condDLGDelegator, "po_order_b.pk_srcmaterial",
        "po_order_b.cffileid").addEditorListener();
    new QFfileFilter(condDLGDelegator, "po_order_b.pk_srcmaterial",
        "po_order_b.cffileid.vskucode").addEditorListener();
  }
}
