...
public class orderoutcustom_config extends AbstractJavaBeanDefinition {
  ...
  public nc.ui.pu.m21.editor.card.beforeedit.OutcustomCardBodyBeforeEditEventHandler getCardBodyBeforeEdit() {
    if (this.context.get("cardBodyBeforeEdit") != null) {
      return (nc.ui.pu.m21.editor.card.beforeedit.OutcustomCardBodyBeforeEditEventHandler) this.context
          .get("cardBodyBeforeEdit");
    }
    nc.ui.pu.m21.editor.card.beforeedit.OutcustomCardBodyBeforeEditEventHandler bean =
        new nc.ui.pu.m21.editor.card.beforeedit.OutcustomCardBodyBeforeEditEventHandler();
  ...
  public nc.ui.uif2.TangramContainer getContainer() {
    ...
    bean.setModel(this.getManageAppModel());
    bean.setTangramLayoutRoot(this.getTBNode_33413d());
  ...
  public nc.ui.pu.m21.service.onway.OrderOutcustomService getManageModelService() {
    if (this.context.get("manageModelService") != null) {
      return (nc.ui.pu.m21.service.onway.OrderOutcustomService) this.context
          .get("manageModelService");
    }
    nc.ui.pu.m21.service.onway.OrderOutcustomService bean =
        new nc.ui.pu.m21.service.onway.OrderOutcustomService();
  ...
  public nc.ui.pu.m21.action.status.outcustom.OutcustomAction getOutcustomAction() {
    if (this.context.get("outcustomAction") != null) {
      return (nc.ui.pu.m21.action.status.outcustom.OutcustomAction) this.context
          .get("outcustomAction");
    }
    nc.ui.pu.m21.action.status.outcustom.OutcustomAction bean =
        new nc.ui.pu.m21.action.status.outcustom.OutcustomAction();
    this.context.put("outcustomAction", bean);
    bean.setModel(this.getManageAppModel());
    bean.setEditor(this.getBillFormEditor());
    bean.setService(this.getManageModelService());
  ...
  public nc.ui.pu.m21.view.OrderOnwayQueryDLGInitializer getQryDLGInitializer() {
    ...
    bean.setFieldcode("bisoutcustom");
    this.setBeanFacotryIfBeanFacatoryAware(bean);
    this.invokeInitializingBean(bean);
    return bean;
  }

  public nc.ui.pu.m21.action.status.outcustom.OutcustomQueryAction getQueryAction() {
    if (this.context.get("queryAction") != null) {
      return (nc.ui.pu.m21.action.status.outcustom.OutcustomQueryAction) this.context
          .get("queryAction");
    }
    nc.ui.pu.m21.action.status.outcustom.OutcustomQueryAction bean =
        new nc.ui.pu.m21.action.status.outcustom.OutcustomQueryAction();
  ...
  public nc.ui.pu.m21.action.status.outcustom.UnoutcustomAction getUnoutcustomAction() {
    if (this.context.get("unoutcustomAction") != null) {
      return (nc.ui.pu.m21.action.status.outcustom.UnoutcustomAction) this.context
          .get("unoutcustomAction");
    }
    nc.ui.pu.m21.action.status.outcustom.UnoutcustomAction bean =
        new nc.ui.pu.m21.action.status.outcustom.UnoutcustomAction();
    this.context.put("unoutcustomAction", bean);
    bean.setModel(this.getManageAppModel());
    bean.setEditor(this.getBillFormEditor());
    bean.setService(this.getManageModelService());
    bean.setDataManager(this.getModelDataManager());
  ...
  public nc.ui.pu.m21.service.onway.OrderOutcustomValidationService getValidateSerice() {
    if (this.context.get("validateSerice") != null) {
      return (nc.ui.pu.m21.service.onway.OrderOutcustomValidationService) this.context
          .get("validateSerice");
    }
    nc.ui.pu.m21.service.onway.OrderOutcustomValidationService bean =
        new nc.ui.pu.m21.service.onway.OrderOutcustomValidationService();
  ...
  private nc.ui.uif2.tangramlayout.node.CNode getCNode_1379b8c() {
    if (this.context.get("nc.ui.uif2.tangramlayout.node.CNode#1379b8c") != null) {
      return (nc.ui.uif2.tangramlayout.node.CNode) this.context
          .get("nc.ui.uif2.tangramlayout.node.CNode#1379b8c");
    }
    nc.ui.uif2.tangramlayout.node.CNode bean =
        new nc.ui.uif2.tangramlayout.node.CNode();
    this.context.put("nc.ui.uif2.tangramlayout.node.CNode#1379b8c", bean);
    bean.setName(this.getI18nFB_fc12d2());
  ...
  private nc.ui.uif2.tangramlayout.node.CNode getCNode_946a1() {
    if (this.context.get("nc.ui.uif2.tangramlayout.node.CNode#946a1") != null) {
      return (nc.ui.uif2.tangramlayout.node.CNode) this.context
          .get("nc.ui.uif2.tangramlayout.node.CNode#946a1");
    }
    nc.ui.uif2.tangramlayout.node.CNode bean =
        new nc.ui.uif2.tangramlayout.node.CNode();
    this.context.put("nc.ui.uif2.tangramlayout.node.CNode#946a1", bean);
  ...
  private java.lang.String getI18nFB_fc12d2() {
    if (this.context.get("nc.ui.uif2.I18nFB#fc12d2") != null) {
      return (java.lang.String) this.context.get("nc.ui.uif2.I18nFB#fc12d2");
    }
    nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    this.context.put("&nc.ui.uif2.I18nFB#fc12d2", bean);
    ...
    try {
      ...
      this.context.put("nc.ui.uif2.I18nFB#fc12d2", product);
  ...
  private List getManagedList3() {
    List list = new ArrayList();
    list.add(this.getVSNode_1c525c7());
    return list;
  }
  ...
  private List getManagedList4() {
    ...
    list.add(this.getSeparatorAction());
    list.add(this.getOutcustomAction());
    list.add(this.getUnoutcustomAction());
    list.add(this.getSeparatorAction());
  ...
  private List getManagedList6() {
    List list = new ArrayList();
    list.add(this.getQueryParam_10033e7());
    list.add(this.getQueryParam_4f8648());
    list.add(this.getQueryParam_f8f083());
    return list;
  }

  private List getManagedList7() {
    List list = new ArrayList();
    list.add(this.getUserdefQueryParam_176657a());
    list.add(this.getUserdefQueryParam_565e());
    return list;
  }
  ...
  private nc.ui.uif2.userdefitem.QueryParam getQueryParam_10033e7() {
    if (this.context.get("nc.ui.uif2.userdefitem.QueryParam#10033e7") != null) {
      return (nc.ui.uif2.userdefitem.QueryParam) this.context
          .get("nc.ui.uif2.userdefitem.QueryParam#10033e7");
    }
    nc.ui.uif2.userdefitem.QueryParam bean =
        new nc.ui.uif2.userdefitem.QueryParam();
    this.context.put("nc.ui.uif2.userdefitem.QueryParam#10033e7", bean);
  ...
  private nc.ui.uif2.userdefitem.QueryParam getQueryParam_4f8648() {
    if (this.context.get("nc.ui.uif2.userdefitem.QueryParam#4f8648") != null) {
      return (nc.ui.uif2.userdefitem.QueryParam) this.context
          .get("nc.ui.uif2.userdefitem.QueryParam#4f8648");
    }
    nc.ui.uif2.userdefitem.QueryParam bean =
        new nc.ui.uif2.userdefitem.QueryParam();
    this.context.put("nc.ui.uif2.userdefitem.QueryParam#4f8648", bean);
  ...
  private nc.ui.uif2.userdefitem.QueryParam getQueryParam_f8f083() {
    if (this.context.get("nc.ui.uif2.userdefitem.QueryParam#f8f083") != null) {
      return (nc.ui.uif2.userdefitem.QueryParam) this.context
          .get("nc.ui.uif2.userdefitem.QueryParam#f8f083");
    }
    nc.ui.uif2.userdefitem.QueryParam bean =
        new nc.ui.uif2.userdefitem.QueryParam();
    this.context.put("nc.ui.uif2.userdefitem.QueryParam#f8f083", bean);
  ...
  private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_33413d() {
    if (this.context.get("nc.ui.uif2.tangramlayout.node.TBNode#33413d") != null) {
      return (nc.ui.uif2.tangramlayout.node.TBNode) this.context
          .get("nc.ui.uif2.tangramlayout.node.TBNode#33413d");
    }
    nc.ui.uif2.tangramlayout.node.TBNode bean =
        new nc.ui.uif2.tangramlayout.node.TBNode();
    this.context.put("nc.ui.uif2.tangramlayout.node.TBNode#33413d", bean);
  ...
  private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_176657a() {
    if (this.context.get("nc.ui.uif2.editor.UserdefQueryParam#176657a") != null) {
      return (nc.ui.uif2.editor.UserdefQueryParam) this.context
          .get("nc.ui.uif2.editor.UserdefQueryParam#176657a");
    }
    nc.ui.uif2.editor.UserdefQueryParam bean =
        new nc.ui.uif2.editor.UserdefQueryParam();
    this.context.put("nc.ui.uif2.editor.UserdefQueryParam#176657a", bean);
    bean.setMdfullname("pu.po_order");
    bean.setPos(0);
    bean.setPrefix("vdef");
    this.setBeanFacotryIfBeanFacatoryAware(bean);
  ...
  private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_565e() {
    if (this.context.get("nc.ui.uif2.editor.UserdefQueryParam#565e") != null) {
      return (nc.ui.uif2.editor.UserdefQueryParam) this.context
          .get("nc.ui.uif2.editor.UserdefQueryParam#565e");
    }
    nc.ui.uif2.editor.UserdefQueryParam bean =
        new nc.ui.uif2.editor.UserdefQueryParam();
    this.context.put("nc.ui.uif2.editor.UserdefQueryParam#565e", bean);
    bean.setMdfullname("pu.po_order_b");
    bean.setPos(1);
  ...
  private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1c525c7() {
    if (this.context.get("nc.ui.uif2.tangramlayout.node.VSNode#1c525c7") != null) {
      return (nc.ui.uif2.tangramlayout.node.VSNode) this.context
          .get("nc.ui.uif2.tangramlayout.node.VSNode#1c525c7");
    }
    nc.ui.uif2.tangramlayout.node.VSNode bean =
        new nc.ui.uif2.tangramlayout.node.VSNode();
    this.context.put("nc.ui.uif2.tangramlayout.node.VSNode#1c525c7", bean);
    bean.setUp(this.getCNode_946a1());
    bean.setDown(this.getCNode_1379b8c());
