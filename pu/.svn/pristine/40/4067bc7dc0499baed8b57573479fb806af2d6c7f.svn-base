 ...
 *
 * @since 6.5
 * @version 2014-1-22 上午11:25:36
 * @author fanly3
 */
public class FinalCloseEventAfterRule implements IRule<StoreReqAppVO> {
  ...
  public void process(StoreReqAppVO[] vos) {
    ...
    try {
      ...
      EventDispatcher.fireEvent(new BusinessEvent(sourceid,
          IStoreReqAppEventType.TYPE_CLOSE_AFTER, vos));
    }
    catch (Exception e) {
