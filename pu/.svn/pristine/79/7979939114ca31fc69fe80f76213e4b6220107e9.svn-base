 ...
 * 
 * @since 6.1
 * @version 2012-8-17 下午04:12:59
 * @author tianft
 */
public class CurMonthEstCurMonthSettle extends AbstractEstMonthStatSqlBuilder {

  public CurMonthEstCurMonthSettle(PuEstDifferQryInfoPara queryPara) {
    super(queryPara);
  }
  ...
  public String getQuerySql() {
    ...
    return settleSql.getQuerySql() + " CurMonthEstCurMonthSettle ";
  }
