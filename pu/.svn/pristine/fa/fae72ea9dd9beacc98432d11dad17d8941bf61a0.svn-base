...
import nc.vo.pu.qst.newoabase.AggNewoabaseaHeadVOMeta;
import nc.bs.framework.common.NCLocator;
import com.yonyou.uat.framework.BaseTestCase;
public class AggNewoabaseaHeadVOMetaTest extends BaseTestCase {
  AggNewoabaseaHeadVOMeta aggNewoabaseaHeadVOMeta=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggNewoabaseaHeadVOMeta=NCLocator.getInstance().lookup(AggNewoabaseaHeadVOMeta.class);
  }
