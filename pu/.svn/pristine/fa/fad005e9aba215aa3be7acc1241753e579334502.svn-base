...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class CgfabTest extends BaseTestCase {
  Cgfab cgfab=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    cgfab=NCLocator.getInstance().lookup(Cgfab.class);
  }
  ...
  public void getPk_equipment_id(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=cgfab.getPk_equipment_id();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_equipment_id(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_equipment_id=(String)dp.get("pk_equipment_id").get(0);
    
    //Invoke tested method
    cgfab.setPk_equipment_id(pk_equipment_id);
