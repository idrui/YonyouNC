...
import nc.ui.pu.m21.rule.OutputScaleSetter;
 ...
 * @since 6.0
 * @author wanghuid
 * @time 2010-8-19 下午03:41:14
 */
public class OutputRowChangedEventHandler implements
  ...
  private void setListScale(ListHeadRowChangedEvent e) {
    ...
    new OutputScaleSetter(pk_group).setListScale(blp);
  }
