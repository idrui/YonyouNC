...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class NewoaspwhaHeadVOTest extends BaseTestCase {
  NewoaspwhaHeadVO newoaspwhaHeadVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    newoaspwhaHeadVO=NCLocator.getInstance().lookup(NewoaspwhaHeadVO.class);
  }
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=newoaspwhaHeadVO.getMetaData();
