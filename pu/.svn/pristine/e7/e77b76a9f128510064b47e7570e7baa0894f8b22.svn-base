...
public class PfPriceStlCheck extends PfBeforeAndAfterAction implements
  ...
  public void callCheckStatus(CheckStatusCallbackContext cscc)
    ...
    try {
      ...
      String[] names =
          new String[] {
            PricestlHeaderVO.FBILLSTATUS, PricestlHeaderVO.APPROVER,
            PricestlHeaderVO.TAUDITTIME
          };
