 ...
 * @author tianft
 */
public class OrigArea implements ICardBodyBeforeEditEventListener {
  ...
  public void beforeEdit(CardBodyBeforeEditEvent event) {
    ...
    String country =
        (String) panel.getBodyValueAt(row, OrderItemVO.CORIGCOUNTRYID);
    ...
    FilterCountryAreaRefUtils areaRef =
        new FilterCountryAreaRefUtils(
            panel.getBodyItem(OrderItemVO.CORIGAREAID));
