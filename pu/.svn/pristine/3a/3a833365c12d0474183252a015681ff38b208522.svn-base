...
public class M4202SqlBuilder extends AbstractSupplierEstSqlBuilder {
  ...
  private String getCurrGoodEstSql() {
    ...
    sb.append("           eb.nestcalcostmny nestmny, ");// v61计成本金额
    ...
    // sb.append("       and isnull(eb.nestmny,0) <> 0");// 有冲销的数据
  ...
  private String getInitialGoodEstSettleUnClashSql() {
    ...
    sb.append("       and (isnull(eb.nestcalcostmny,0)-isnull(eb.naccestcostwashmny,0)) <> 0");// 有冲销的数据
    sb.append("       and eb.dtocostapdate<='"
        + this.getPara().getBegindate().toString() + "'");
    sb.append("       and ");
    sb.append(this.getGoodCommonWhere());
  ...
  protected String getCurrFeeClashSql() {
    ...
    sb.append("           0 nestmny, ");
    sb.append("           0 nsettlenum, ");
    sb.append("           0 ngoodsmoney, ");// 费用分摊金额
    // sb.append("           ef.nestmny nclashestmoney ");// 冲销暂估金额
    sb.append("           ef.ncalcostmny nclashestmoney ");// 冲销暂估金额v61计成本金额
  ...
  protected String getCurrFeeEstSql() {
    ...
    sb.append("       0 estnum, ");// 费用暂估数量为0
    // sb.append("       isnull(fe.nestmny,0) estmny,  ");// 费用暂估金额即未冲销的金额
    sb.append("       isnull(fe.ncalcostmny,0) estmny,  ");// 费用暂估金额即未冲销的金额v61计成本金额
    sb.append("       0 nsettlenum, ");
    sb.append("       0 ngoodsmoney, ");
    sb.append("       0 nclashestmoney ");
    sb.append("  FROM po_vmifi eb ");
  ...
  protected String getInitialFeeEstSql() {
    ...
    // sb.append("       isnull(eb.nestmny,0) unestmny,  ");// 费用暂估金额即未冲销的金额
    sb.append("       isnull(eb.nestcalcostmny,0) unestmny,  ");// 费用暂估金额即未冲销的金额v61计成本金额
    sb.append("       0 estnum, ");
    sb.append("       0 nestmny, ");
    sb.append("       0 nsettlenum, ");
    sb.append("       0 ngoodsmoney, ");
