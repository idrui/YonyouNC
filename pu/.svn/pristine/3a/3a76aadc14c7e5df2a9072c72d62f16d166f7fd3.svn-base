 ...
 * 
 * @since 6.0
 * @version 2011-1-13 下午01:06:29
 * @author yinfy
 */

public class CheckQueryDLGInitializer implements IQueryConditionDLGInitializer {
  ...
  private void filterRef(QueryConditionDLGDelegator condDLGDelegator) {
    ...
    new QMarterialoidFilter(condDLGDelegator, ArriveItemVO.PK_ORG,
