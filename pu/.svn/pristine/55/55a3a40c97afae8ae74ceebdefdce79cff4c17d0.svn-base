 ...
 * @time 2010-4-9 上午08:35:06
 */
public class PayRowCloseAction extends AfterOrderCloseAction {

  /**
   *
   */
  private static final long serialVersionUID = -188658261288920768L;

  private OrderCloseManageModel model = null;

  public PayRowCloseAction() {
    SCMActionInitializer.initializeAction(this, SCMActionCode.PU_PAYCLOSE);
    // this.setBtnName("付款关闭");
    // this.setCode("payRowClose");
  ...
  private void doBeforeAction() {
    if (ArrayUtils.isEmpty(this.model.getSelectedOperaDatas())) {
      ExceptionUtils.wrappBusinessException(nc.vo.ml.NCLangRes4VoTransl
          .getNCLangRes().getStrByID("4004030_0", "04004030-0014")/*
                                                                   * @res
                                                                   * "请先选择付款关闭行"
                                                                   */);
    }
