 ...
 */
public class OnWayEventHandler implements
  ...
  public void handleAppEvent(CardBodyRowStateChangeEvent e) {
    ...
    ((OnwayStatusBillForm) this.editor).getBillCardPanel().getBodyPanel()
    ...
    ISuperVO[] bodySelectedVOs =
        ((OnwayStatusBillForm) this.editor).getBodySelectedVOs();
