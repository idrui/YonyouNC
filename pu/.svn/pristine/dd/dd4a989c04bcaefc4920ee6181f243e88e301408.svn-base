...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class NewoaspwhbBodyVOTest extends BaseTestCase {
  NewoaspwhbBodyVO newoaspwhbBodyVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    newoaspwhbBodyVO=NCLocator.getInstance().lookup(NewoaspwhbBodyVO.class);
  }
  ...
  public void getPk_id_a(  Map<String,ArrayList<String>> dp){
    ...
    String retObj="";
    retObj=newoaspwhbBodyVO.getPk_id_a();
  ...
  public void setPk_id_a(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    newoaspwhbBodyVO.setPk_id_a(pk_id_a);
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=newoaspwhbBodyVO.getMetaData();
