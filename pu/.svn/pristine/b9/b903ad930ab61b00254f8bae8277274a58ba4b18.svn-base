...
/**
 * @since 6.0
 * @version 2011-4-2 下午04:22:36
 * @author yinfy
 */

public class ArrivalBatchFetcher extends OrderBatchFetcher {
  @Override
  protected String getExecQuerySql(NtbParamVO seed, NtbParamVO[] params,
    ...
    if (PuBillBusiSysReg.NNUM.equals(type)) {
      select.append("select sum(b.naccumarrvnum) ");
      ...
      select
          .append("select 0,0,0,sum(coalesce(b.norigtaxnetprice,0)*coalesce(b.naccumarrvnum,0)) ");
