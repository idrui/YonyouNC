 ...
 * @time 2010-4-8 下午06:19:42
 */
public class ArriveAllCloseAction extends AfterOrderCloseAction {
  ...
  public void doAction(ActionEvent e) throws Exception {
    ...
    OrderVO[] returnVos =
        orderCloseService.close(lightVOs,
            ((Integer) EnumCloseFlag.ARRIVE_CLOSE.value()).intValue(), true);
  ...
  private void doBeforeAction() {
    if (ArrayUtils.isEmpty(this.model.getSelectedOperaDatas())) {
      ExceptionUtils.wrappBusinessException(nc.vo.ml.NCLangRes4VoTransl
          .getNCLangRes().getStrByID("4004030_0", "04004030-0001")/*
                                                                   * @res
                                                                   * "请先选择要整单到货关闭行"
                                                                   */);
    }
