...
/** 2016-12-22增加扩展字段  **/
  ...
  public String sts_req;              //计划状态                  
  public String req_document;         //放行文号                  
  public String code_proj_cst;        //客户工程编号              
  public String name_proj_cst;        //客户工程名称              
  public String name_machine;         //主机名称                  
  public String material_quality;     //材质                      
  public Integer rating_life;          //额定寿命（天）            
  public String cde_manufac;          //原始制造商编码            
  public String name_manufac;         //生产商名称（原始制造商）  
  public UFDouble pric_req;             //计划价格（计划单价不含税）
  public UFDouble pric_req_rat;         //计划价格（计划单价含税）  
  public UFDouble tot_pric_req;         //计划总价不含税            
  public UFDouble tot_pric_req_rat;     //计划总价含税              
  public String seq_fac_plan;         //客户计划号-工厂计划号     
  public String seq_fac_no;           //工厂计划行号              
  public String cde_fact;             //客户编号-工厂代码         
  public String name_fact;            //客户名称-工厂名称         
  public String remark_plan;          //计划说明                  
  public String banfn;                //采购申请号                
  public String bnfpo;                //采购申请行号              
  public String req_group;            //采购组                    
  public String req_group_b;          //采购组织                  
  public String code_facty;           //公司代码                  
  public String cde_equipment;        //备件编号或代码            
  public String checker_fac;          //点检员                    
  public UFDateTime tmstp_dispatch;       //计划分配时间
  
  public Integer unit_pric;          //价格单位                    
  public String group_matl;       //物料组        
...
/**
 * @param req_document 要设置的 req_document
 */
...
/**
 * @param code_proj_cst 要设置的 code_proj_cst
 */
...
/**
 * @param name_proj_cst 要设置的 name_proj_cst
 */
...
/**
 * @param name_machine 要设置的 name_machine
 */
...
/**
 * @param material_quality 要设置的 material_quality
 */
...
/**
 * @param rating_life 要设置的 rating_life
 */
...
/**
 * @param cde_manufac 要设置的 cde_manufac
 */
...
/**
 * @param name_manufac 要设置的 name_manufac
 */
...
/**
 * @param pric_req_rat 要设置的 pric_req_rat
 */
...
/**
 * @param tot_pric_req 要设置的 tot_pric_req
 */
...
/**
 * @param tot_pric_req_rat 要设置的 tot_pric_req_rat
 */
...
/**
 * @param seq_fac_plan 要设置的 seq_fac_plan
 */
...
/**
 * @param seq_fac_no 要设置的 seq_fac_no
 */
...
/**
 * @param name_fact 要设置的 name_fact
 */
...
/**
 * @param remark_plan 要设置的 remark_plan
 */
...
/**
 * @param req_group 要设置的 req_group
 */
...
/**
 * @param req_group_b 要设置的 req_group_b
 */
...
/**
 * @param code_facty 要设置的 code_facty
 */
...
/**
 * @param cde_equipment 要设置的 cde_equipment
 */
...
/**
 * @param checker_fac 要设置的 checker_fac
 */
...
/**
 * @param tmstp_dispatch 要设置的 tmstp_dispatch
 */
...
/**
 * @param unit_pric 要设置的 unit_pric
 */
...
/**
 * @param group_matl 要设置的 group_matl
 */
