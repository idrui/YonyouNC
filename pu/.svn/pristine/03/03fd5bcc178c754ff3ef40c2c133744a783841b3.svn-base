 ...
 * @time 2010-9-2 上午10:40:14
 */
public class OrderLoadValidationService extends AbstractOnwayValidationService {
  ...
  void docheck(PoTransTypeVO transtypeVO, OrderOnwayItemVO[] voitems)
    ...
    OnwayValidationTool.chkEmptyForOnway(transtypeVO, voitems,
        PoTransTypeVO.BLOADCODE, PoTransTypeVO.BLOADDATE,
        OnwayStatusQryEnum.bisload.getName());
