 ...
 * @time 2010-7-20 下午04:33:35
 */
public abstract class AbstractUnOnwayStatusAction extends NCAction {

  private static final long serialVersionUID = 50843243876331483L;
  ...
  public AbstractUnOnwayStatusAction() {
    super();
  }
  ...
  protected boolean isActionEnable() {
    ...
    // for (OrderOnwayItemVO vo : vos) {
    // if (vo.getFonwaystatus() == null
    // || !vo.getFonwaystatus().equals(this.getStatus())) {
    // return false;
    // }
    // }
    // return true;
