package nc.pubimpl.pu.m21.mmpps.planbusi;

import nc.pubitf.pu.m21.mmpps.planbusi.IQueryPurOrderMapForSA;
import nc.pubitf.pu.m21.mmpps.planbusi.PurchaseOrderSASupplyMapVO;
...
/**
 * PU-供给影响分析查询供给-采购订单字段映射实现类
 * 
 * @since 6.0
 * @version 2012-11-7 上午09:27:26
 * @author liuyand
 */
