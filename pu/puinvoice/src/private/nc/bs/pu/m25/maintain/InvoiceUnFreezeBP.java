 ...
 * @see
 * @since 6.0
 * @time 2010-4-7 下午03:07:19
 */
package nc.bs.pu.m25.maintain;

import nc.bs.pu.m25.maintain.rule.freeze.InvoiceUnFreezeClearInfoRule;
 ...
 * @time 2010-4-7 下午03:07:19
 */
public class InvoiceUnFreezeBP {
  public InvoiceVO[] unFreeze(InvoiceVO[] invoiceVOs, InvoiceVO[] orgVos) {
  ...
  private void addRule(CompareAroundProcesser<InvoiceVO> processer) {
    processer.addBeforeRule(new InvoiceUnFreezeClearInfoRule());
