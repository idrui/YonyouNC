 ...
 * @author 高光荣
 */
public class PositionRefModel extends AbstractRefModel {

  public PositionRefModel(String refNodeName) {
  ...
  public void setRefNodeName(String refNodeName) {
    ...
    this.setFieldName(new String[] {
      nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0001669")/*@res "岗位编码"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0001657")/*@res "岗位名称"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003481")/*@res "计划员"*/
    });
