...
public class AggCgfaTest extends BaseTestCase {
  AggCgfa aggCgfa=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggCgfa=NCLocator.getInstance().lookup(AggCgfa.class);
  }
  ...
  public void getParentVO(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    Cgfa retObj=new Cgfa();
    retObj=aggCgfa.getParentVO();
