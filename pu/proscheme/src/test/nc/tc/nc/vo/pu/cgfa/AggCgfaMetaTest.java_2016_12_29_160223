...
import nc.vo.pu.cgfa.AggCgfaMeta;
import nc.bs.framework.common.NCLocator;
import com.yonyou.uat.framework.BaseTestCase;
public class AggCgfaMetaTest extends BaseTestCase {
  AggCgfaMeta aggCgfaMeta=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggCgfaMeta=NCLocator.getInstance().lookup(AggCgfaMeta.class);
  }
