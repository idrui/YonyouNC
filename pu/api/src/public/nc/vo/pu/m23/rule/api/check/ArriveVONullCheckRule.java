...
public class ArriveVONullCheckRule implements IRule<ArriveVO>{
  ...
  private void checkBodyItem(ArriveItemVO[] bvo) {
    ...
    itemArray[7] = new ChkItemInfo(ArriveItemVO.CSOURCETYPECODE, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002753")/*@res "来源单据类型"*/);
    itemArray[8] = new ChkItemInfo(ArriveItemVO.VSOURCETRANTYPE, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4004040_0","04004040-0156")/*@res "来源交易类型"*/);
    itemArray[9] = new ChkItemInfo(ArriveItemVO.VSOURCECODE, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002750")/*@res "来源单据号"*/);
    itemArray[10] = new ChkItemInfo(ArriveItemVO.VSOURCEROWNO, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4004040_0","04004040-0157")/*@res "来源单据行号 "*/);
    itemArray[11] = new ChkItemInfo(ArriveItemVO.PK_APFINANCEORG_V, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4004040_0","04004040-0158")/*@res "应付组织"*/);
    itemArray[12] = new ChkItemInfo(ArriveItemVO.PK_PSFINANCEORG_V, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4004040_0","04004040-0159")/*@res "结算财务组织"*/);
