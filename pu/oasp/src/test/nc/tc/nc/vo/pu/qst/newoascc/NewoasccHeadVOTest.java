package nc.tc.nc.vo.pu.qst.newoascc;
import org.testng.*;
...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class NewoasccHeadVOTest extends BaseTestCase {
  NewoasccHeadVO newoasccHeadVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    newoasccHeadVO=NCLocator.getInstance().lookup(NewoasccHeadVO.class);
  }
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=newoasccHeadVO.getMetaData();
