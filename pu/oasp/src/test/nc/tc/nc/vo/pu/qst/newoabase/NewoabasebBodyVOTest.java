package nc.tc.nc.vo.pu.qst.newoabase;
import org.testng.*;
...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class NewoabasebBodyVOTest extends BaseTestCase {
  NewoabasebBodyVO newoabasebBodyVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    newoabasebBodyVO=NCLocator.getInstance().lookup(NewoabasebBodyVO.class);
  }
  ...
  public void getPk_id_a(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=newoabasebBodyVO.getPk_id_a();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_id_a(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_id_a=(String)dp.get("pk_id_a").get(0);
    
    //Invoke tested method
    newoabasebBodyVO.setPk_id_a(pk_id_a);
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=newoabasebBodyVO.getMetaData();
