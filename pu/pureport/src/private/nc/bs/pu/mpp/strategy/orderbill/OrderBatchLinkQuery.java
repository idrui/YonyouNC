...
/**
 * @since 6.0
 * @version 2011-6-21 下午05:09:10
 * @author wuxla
 */

public class OrderBatchLinkQuery extends OrderBatchFetcher {
  public OrderVO[] execLinkQuery21(NtbParamVO vo) {
    ...
    try {
      OrderVO[] vos = service.queryOrderVOByBids(bids);
      return vos;
    }
  ...
  public OrderVO[] readyLinkQuery21(NtbParamVO vo) {
    TbbTempTableSqlBuilder tbbuilder = new TbbTempTableSqlBuilder();
