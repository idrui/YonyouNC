...
import nc.vo.pu.report.initializer.OrderSummaryQueryInitializer;
...
public class OrderSummarySubConverter extends SCMRptAbsSubConvertor {
  ...
  protected void doBusinessProcess(IQueryCondition condition, IContext context) {
    ...
    for (ConditionVO condVo : conds) {
      if (OrderSummaryQryFieldCode.pk_org.getFieldCode().equals(
          condVo.getFieldCode())) {
  ...
  protected ISCMReportQueryInitializer getReportInitializer() {
    return new OrderSummaryQueryInitializer();
  }
