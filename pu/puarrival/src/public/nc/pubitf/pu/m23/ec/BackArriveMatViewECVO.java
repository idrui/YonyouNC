...
/**
 * @since 6.0
 * @version 2011-5-16 下午01:00:30
 * @author wuxla
 */

public class BackArriveMatViewECVO extends AbstractDataView {
  public static class BackArriveMatViewECVOMeta extends DataViewMeta {
    public BackArriveMatViewECVOMeta() {
      this.init();
    }
  ...
  private static final long serialVersionUID = -4826246319454656145L;
  ...
  public IDataViewMeta getMetaData() {
    return DataViewMetaFactory.getInstance().getDataViewMeta(
        BackArriveMatViewECVOMeta.class);
  }
