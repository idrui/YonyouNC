 ...
 * @since 6.0
 * @author GGR
 * @time 2010-5-20 下午06:19:55
 */
public class BillReferQueryFor61 extends DefaultBillReferQuery {

  public BillReferQueryFor61(Container c, TemplateInfo info) {
    super(c, info);
  }
  ...
  private void setFilter(QueryConditionDLGDelegator dlgDelegator) {
    ...
    // 订单交易类型，参照采购订单交易类型录入
    new QTransTypeFilter(dlgDelegator, "pk_praybill_b.cordertrantypecode", "61")
        .filter();
    ...
    // 需求仓库
    new QWareHouseFilter(dlgDelegator, "pk_org", "pk_praybill_b.pk_reqstor")
        .addEditorListener();
