 ...
 */
public class QueryFor29BP extends AbstractRefQueryBP {

  public QueryFor29BP(QuerySchemeProcessor psor) {
    super(psor);
  }
  ...
  public StringBuffer makeGetPKSql() {
    ...
    // 处理是否已经生成询报价单
    CondTOWhereUtil.buildIsgenaskbill(this.psor, sql, this.itemtb);
