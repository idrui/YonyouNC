 ...
 * @since 6.1
 * @author lixyp
 * @time 2011-12-29 上午10:41:45
 */
public class PushSave20ForA2Action {
  public void pushSave(PraybillVO[] praybills) {
    ...
    AroundProcesser<PraybillVO> processer =
        new AroundProcesser<PraybillVO>(ActionPlugInPoint.PushSave20ForA2Action);
    // 加入Action中的执行前/后规则
  ...
  protected String getBillCode() {
    return MMBillType.ProduceOrder.getCode();
  }
}
